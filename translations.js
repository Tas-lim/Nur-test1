...
window.TRANSLATIONS = {
    ...
    ar: {
        ...
        meta: {
            ...
            title:
                "نور القرآن | محمد بن أحمد بأه",

            description:
                "الموقع الرسمي للتعريف بكتاب نور القرآن للمؤلف محمد بن أحمد بأه. استمع إلى التسجيلات الصوتية، واطّلع على صفحات مختارة، واحصل على نسختك."
